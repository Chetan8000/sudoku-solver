...
# Define augmentation
data_gen_args = dict(
    width_shift_range=0.3, height_shift_range=0.3, zoom_range=0.5, fill_mode="nearest"
)
...
cp_1 = ModelCheckpoint(
    "best_model_lenet_aug_loss_3.model",
    monitor="val_loss",
    mode="min",
    save_best_only=True,
    verbose=1,
...
cp_2 = ModelCheckpoint(
    "best_model_lenet_aug_acc_3.model",
    monitor="val_acc",
    mode="max",
    save_best_only=True,
    verbose=1,
...
H = model.fit_generator(
    X_datagen.flow(X_train, y_train, batch_size=32),
